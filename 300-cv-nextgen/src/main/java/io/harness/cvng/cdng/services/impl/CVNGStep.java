...
public class CVNGStep extends AsyncExecutableWithRollback {
  ...
  @Inject private Map<MonitoredServiceSpecType, VerifyStepCvConfigService> verifyStepCvConfigServiceMap;
  ...
  public AsyncExecutableResponse executeAsync(Ambiance ambiance, StepElementParameters stepElementParameters,
    ...
    String monitoredServiceIdentifier =
        verifyStepCvConfigServiceMap.get(monitoredServiceType)
            .getMonitoredServiceIdentifier(serviceEnvironmentParams, monitoredServiceNode);
    List<CVConfig> cvConfigs = verifyStepCvConfigServiceMap.get(monitoredServiceType)
                                   .getCVConfigs(serviceEnvironmentParams, monitoredServiceNode);
