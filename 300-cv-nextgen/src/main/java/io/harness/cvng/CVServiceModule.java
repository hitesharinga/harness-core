...
import io.harness.cvng.analysis.services.api.*;
import io.harness.cvng.analysis.services.impl.*;
...
import io.harness.cvng.core.entities.changeSource.*;
...
import io.harness.cvng.core.jobs.*;
...
import io.harness.cvng.core.transformer.changeEvent.*;
import io.harness.cvng.core.transformer.changeSource.*;
import io.harness.cvng.core.utils.monitoredService.*;
import io.harness.cvng.dashboard.services.api.*;
import io.harness.cvng.dashboard.services.impl.*;
...
import io.harness.cvng.notification.transformer.*;
...
import io.harness.cvng.servicelevelobjective.transformer.servicelevelindicator.*;
import io.harness.cvng.statemachine.beans.AnalysisState.StateType;
import io.harness.cvng.statemachine.services.api.*;
...
public class CVServiceModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    boolean isEnabledAudit = true;
    install(new AuditClientModule(serviceHttpClientConfig, secret, serviceId, isEnabledAudit));
