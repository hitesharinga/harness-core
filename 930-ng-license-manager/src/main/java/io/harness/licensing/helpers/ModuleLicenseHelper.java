  ...
  public static ModuleLicense compareAndUpdate(ModuleLicense current, ModuleLicense update) {
    ...
    switch (update.getModuleType()) {
      ...
      case STO:
        ...
        if (stoLicense.getNumberOfCommitters() != null
            && !stoLicense.getNumberOfCommitters().equals(currentSTOLicense.getNumberOfCommitters())) {
          currentSTOLicense.setNumberOfCommitters(stoLicense.getNumberOfCommitters());
        }
        break;
      default:
        // Do nothing
